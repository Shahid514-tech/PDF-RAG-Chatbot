...
# ---------------- Handle Event Loop ----------------
# Sometimes async libraries complain if there's no running event loop.
# This makes sure one exists before we run the app.
try:
...
st.title("PDF RAG Chatbot with Gemini + LangChain")
